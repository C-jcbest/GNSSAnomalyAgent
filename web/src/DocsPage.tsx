  ...
  return (
    <section className="docs-page" aria-label="实验设计文档">
      <div className="docs-hero">
        ...
        <span className="docs-stage">06 / P6 设计完成</span>
      </div>
      ...
      <div className="docs-layout">
        ...
        <article className="docs-paper" aria-label={title}>
          {loading ? (
            ...
            <>
              <div className="docs-paper-topline"><span>GNSS SIMULATION LAB</span><span>{selected === "p1-normal-model" ? "FROZEN BACKGROUND · P1" : selected === "planned-methods" ? "EVENT PROTOCOL · P2/P3" : selected === "p4-pilot-evaluator" ? "PILOT & EVALUATOR · P4" : selected === "p5-numerical-baselines" ? "NUMERICAL BASELINES · P5" : selected === "p6-visual-baseline" ? "VISUAL DESIGN · P6" : "RESEARCH NOTE"}</span></div>
