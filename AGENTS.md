...
- `event-v2` 固定背景：2025 年 365 日、P0=(0,0,0) mm、annual/semiannual 幅值 1.5/1.5/2.0 与 0.5/0.5/1.0 mm、365.25 日周期、白噪声标准差 0.75/0.75/1.5 mm。数值是受控 benchmark 设定，不代表现场精度；不加 AR(1)、secular deformation 或兼容层。
